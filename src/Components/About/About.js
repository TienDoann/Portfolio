        ...
        <div className="info" >
          ...
          <div style={{ width: '800px' }}>
            ...
            <p style={{ color: "white", fontSize: '25px', fontWeight: '90', textIndent: '30px' }}>
              Có 6 tháng kinh nghiệm maintain và phát triển dự án Web Application vị trí Front-end. Đã có cơ hội tham gia phát triển dự án thực tế
              khi còn trong quá trình thực tập.Hiện đang tự học và tìm hiểu Reactjs .Là sinh viên đã tốt nghiệp vào tháng 2 năm 2023 và mục tiêu trở thành
              Software Engineer, tôi mong muốn có cơ hội học hỏi thêm kinh nghiệm, sẵn sàng học hỏi kiến thức mới,thử thách và phát triển bản thân.</p>
